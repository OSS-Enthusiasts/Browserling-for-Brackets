...
define((require) => {
  describe('src/SHA1.js =>', () => {
    const { encodeToSHA1 } = require('../src/hashing/SHA1');
    it('Should encode and decode pure text', () => {
      ...
      expect(encodeToSHA1(clearText)).toEqual(encodedText);
    });
    ...
    describe('Encode/decode testing special characters =>', () => {
      it('should encode and decode text with spaces', () => {
        ...
        expect(encodeToSHA1(clearText)).toEqual(encodeText);
      });
      it('Should encode and decode text with special characters', () => {
        ...
        // eslint-disable-next-line max-len
        const encodeText = 'e8efb934e665b841e5a3d161c336fb82f6434df4';
        expect(encodeToSHA1(clearText)).toEqual(encodeText);
      });
    });
  });
